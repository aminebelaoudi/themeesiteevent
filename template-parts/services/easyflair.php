...
<section class="service-hero service-hero--parallax" style="background:<?php echo esc_attr( $C['dark'] ); ?>">
  <div class="service-hero__bg">
    <img src="<?php echo esc_url( $thumb_url ? $thumb_url : $img['easyflair'] ); ?>" alt="EasyFlair — Bars & Mixologie" class="service-hero__img" loading="eager">
...
<!-- ━━━━ TABS SECTION ━━━━ -->
<section id="prestations" class="svc-section" style="background:<?php echo esc_attr( $C['cream'] ); ?>;position:relative;overflow:hidden">
